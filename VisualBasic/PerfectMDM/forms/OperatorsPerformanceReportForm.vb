Public Class OperatorsPerformanceReportForm
    Private Sub RefreshButton_Click(sender As Object, e As EventArgs) Handles RefreshButton.Click
        ...
        ElseIf (index = 1)
            RefreshCompletedOrdersReport(dateFromValue, dateToValue)
        Else
            RefreshAcceptedOrdersReport(dateFromValue, dateToValue)
        End If
    End Sub
    ...
    Private Sub RefreshCompletedOrdersReport(dateFromValue As Date, dateToValue As Date)
        Dim cmd As New SqlClient.SqlCommand
        cmd.Connection = mcnnInt
        cmd.CommandText = "sp_R20011"
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.Add(New SqlClient.SqlParameter("@Data1", SqlDbType.DateTime))
        cmd.Parameters("@Data1").Value = dateFromValue
        cmd.Parameters.Add(New SqlClient.SqlParameter("@Data2", SqlDbType.DateTime))
    ...
    Private Sub RefreshAcceptedOrdersReport(dateFromValue As Date, dateToValue As Date)
        Dim cmd As New SqlClient.SqlCommand
        cmd.Connection = mcnnInt
        cmd.CommandText = "sp_R20010"
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.Add(New SqlClient.SqlParameter("@Data1", SqlDbType.DateTime))
        cmd.Parameters("@Data1").Value = dateFromValue
        cmd.Parameters.Add(New SqlClient.SqlParameter("@Data2", SqlDbType.DateTime))
