...
Class CrystalClearThemeContainer
    ...
    Protected Overrides Sub PaintHook()
        ...
        'Draw glow
        'G.FillRectangle(New SolidBrush(G1), New Rectangle(New Point(1, 1), New Size(Width - 2, 11)))
...
Class CrystalClearControlBox
    ...
    Protected Overrides Sub OnAnimation()
        ...
        Select Case State
            Case MouseState.Over
                ...
                If b1 < 24 And X > 22 And X <= 46 Then
                    b1 += 4
                    If a > 0 Then
                        a -= 4
                    End If
    ...
    Protected Overrides Sub PaintHook()
        ...
        Dim SB1_ As New SolidBrush(Color.FromArgb(b1, Color.Cyan))
